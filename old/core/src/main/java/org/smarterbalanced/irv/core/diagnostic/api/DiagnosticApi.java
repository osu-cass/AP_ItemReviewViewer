...
public class DiagnosticApi extends BaseDiagnostic {
	 ...
	 *             The empty constructor only exists for the XML serializer.
	 */
	...
	/**
	 * Run the diagnostics for the class's diagnostics level and all levels
	 * lower.
	 */
	...
	void generateStatus() {
		...
		case 1:
			...
			break;
		// Level 0 diagnostics just test to see if the system is up. If it makes
		// it this far it is.
		case 0:
			this.statusRating = 4;
			break;
	 ...
	 *
	 * @param time
	 *            the timestamp for the diagnostics
	 */
	 ...
	 *
	 * @param configurationDiagnostic
	 *            the configuration diagnostic
	 */
	 ...
	 *
	 * @param databaseDiagnostic
	 *            the database diagnostic
	 */
	 ...
	 *
	 * @param providersDiagnostic
	 *            the providers diagnostic object
	 */
